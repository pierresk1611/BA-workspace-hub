...
3. **Lokálna perzistencia:** Všetky informácie sú uložené v `localStorage` vášho prehliadača. Dáta ostávajú zachované aj po obnovení stránky alebo opätovnom prihlásení na tom istom zariadení.
4. **Žiadna databáza:** Aplikácia nemá backendovú databázu. SQL Workspace simuluje prácu s dátami v sandbox režime nad manuálne vloženými textami.
