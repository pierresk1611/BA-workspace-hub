...
const sidebarItems: SidebarItem[] = [
  ...
  { key: "settings", label: "Nastavenia", icon: Settings, projectScoped: false }
];
...
export function Sidebar() {
  ...
  return (
    <div className="w-72 h-full bg-slate-900 text-slate-400 flex flex-col border-r border-slate-800 z-50 shrink-0">
      ...
      {/* Navigation */}
      <div className="flex-1 overflow-y-auto py-6 px-3 space-y-1 custom-scrollbar scrollbar-dark">
            ...
            <NavLink
              ...
              onClick={(e) => {
                if (item.projectScoped && !currentProjectId) {
                  // The user requested that clicking a project-scoped item without a project
                  // should navigate to /projects
                  // This is handled inherently because buildSidebarPath returns "/projects"
                  // but we can add an extra safety step if needed.
                }
              }}
              className={cn(
