...
| Dátum | Modul | Popis zmien | Commit |
|-------|-------|-------------|--------|
| 2026-04-26 | Core | Implementácia Clean Workspace Policy. Odstránenie automatických demo dát zo source kódu a runtime bundle. | fix: enforce clean workspace policy |
