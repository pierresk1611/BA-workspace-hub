...
3. **Lokálny stav (Mock):** Všetky informácie sú uložené iba v lokálnom stave aplikácie and mock súboroch. Po obnovení stránky (v tejto verzii) sa dáta vracajú do predvoleného mock stavu.
3. **Žiadna databáza:** Aplikácia nemá backendovú databázu ani connection stringy. SQL Workspace simuluje prácu s dátami v sandbox režime nad manuálne vloženými textami.
...
7. **Odstránenie dát:** Funkcia "Vymazať projekt" zabezpečuje úplné odstránenie všetkých lokálne naviazaných údajov o danom projekte z pamäte aplikácie. Táto akcia je nevratná v rámci aktuálnej session.
